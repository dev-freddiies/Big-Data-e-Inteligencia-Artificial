...
public class mayoryMenor {
	...
	public static void main(String[] args) {	// Es el main del programa
        ...
        mayor = notas[0];		// Creamos una variable que se llame mayor, que nos servira mas tarde para sacar cual es el numero mayor y la inicializamos al vector notas
        menor = notas[0];		// Creamos una variable que se llame menor, que nos servira mas tarde para sacar cual es el numero menor y la inicializamos al vector notas
       
        for (int i = 0; i < notas.length; i++) {		// Nos creamos un bucle for que vaya desde el 0 hasta la longitud del vector y que vaya incrementando de 1 en 1
        	
            if(notas [i] > mayor) {		// Si lo que hay en el array es mayor que lo que hay en la variable mayor
            	
                mayor = notas[i];		// Mayor toma el valor mayor que hay en el array
                
            }
            
            if(notas[i]<menor) {		// Igual que con el menor
        ...
        System.out.println("El mayor valor es: "+ mayor); // Mostramos el resultado
        
		System.out.println("");
        
        System.out.println("El menor valor es: "+ menor + " que esta en la posicion: ");
