	...
	public static void main(String[] args) { // Es el main del programa
		...
		System.out.println("Se va a hacer ahora solamente con el uso del while");
			...
			if (bandera = true) {
				...
				if (nombre.equals("alumno") && pass.equals("ejemplo")) {
					
					System.out.println("Enhorabuena, se ha logeado como alumno");
			}
				...
				while (nombre != "alumno" && pass != "ejemplo") {
